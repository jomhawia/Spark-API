...
namespace e_commerce.Controllers
{
    ...
    public class SubCategoryController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<List<SubCategoryGetDto>>> Get()
        ...
        public async Task<ActionResult<SubCategoryGetDto>> Post([FromForm] SubCategoryCreateDto dto)
        {
            try
            {
        ...
        [HttpPut("{id:int}")]
        [Consumes("multipart/form-data")]
        public async Task<ActionResult> Put(int id, [FromForm] SubCategoryUpdateDto dto)
        {
            try
            {
